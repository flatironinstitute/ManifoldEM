...
def op(input_data, conOrderRange, traj_name, isFull, psiTrunc):
    ...
    for psinum in psi_list:  #for each reaction coordinates do the following:
        ...
        IMGT, Topo_mean, psirec, psiC1, sdiag, VX, mu, tau = NLSA.op(NLSAPar, DD, posPath, PosPsi1, imgAll, msk2, CTF,
                                                                     ExtPar)  # April 2020, pass the msk2 var also
        kk = 10
