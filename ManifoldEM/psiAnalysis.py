...
def psi_analysis_single(input_data, con_order_range, traj_name, is_full, psi_trunc):
    psi_file = input_data[0]  # 15-dim diffusion map coordinates
    psi2_file = input_data[1]  # output to be generated by Psi Analysis
    EL_file = input_data[2]
...
def _construct_input_data(N):
    ...
    for prD in range(N):
        ...
        ll.append([psi_file, psi2_file, EL_file, psinums, senses, prD, psi_list])
    return ll
