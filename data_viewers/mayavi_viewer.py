...
class Mayavi_Scene(HasTraits):
    ...
    def update_scene(self):
        ...
        if 1:
            rel_plot = mlab.points3d(rel_X, rel_Y, rel_Z, scale_mode='none', scale_factor=.5, figure=Mayavi_Scene.fig1)
            rel_plot.actor.property.color = (0.0, 1.0, 1.0)

    view = View(
        VGroup(
            Group(
                Item('scene', editor=SceneEditor(scene_class=MayaviScene), height=300, width=300, show_label=False),
